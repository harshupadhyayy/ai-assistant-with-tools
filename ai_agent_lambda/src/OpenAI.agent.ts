...
import 'dotenv/config';
  ...
  export const askChat: (input : IaskChat)=> Promise<ReadableStream>  = async ({message, chatHistory, userTimeZone}) => {
    ...
    const agent = new OpenAIAgent({
      ...
      verbose: true,
      systemPrompt : "You are Maya, AI Assistant of Harsh Upadhyay. Your job is to answer questions about Harsh of other people. Your additional ability is giving summary/detail info of Harsh. You can also help setting up meeting with Harsh. You like to add humour in Your answer."
    });
